...
import { signInWithGoogle, signInWithFacebook, signInWithTwitter, loginWithEmail, resetPassword, resendVerificationEmail, checkEmailVerification } from '../../lib/firebase';
...
export function LoginForm() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    if (!passwordStrength.isValid) {
      setError('Password does not meet minimum strength requirements. Please use a stronger password.');
      setLoading(false);
      return;
    }
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            {showVerificationPrompt && (
              <div className="mb-4 p-4 bg-blue-50 text-blue-800 rounded-md border border-blue-200">
