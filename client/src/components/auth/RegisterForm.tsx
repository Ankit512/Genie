...
import { registerWithEmail, signInWithGoogle, signInWithFacebook, signInWithTwitter, resendVerificationEmail, db } from '../../lib/firebase';
...
export function RegisterForm() {
  ...
  const handleEmailRegister = async (e: React.FormEvent) => {
    ...
    if (!passwordStrength.isValid) {
      setError('Password does not meet minimum strength requirements. Please choose a stronger password.');
      setLoading(false);
      return;
    }
